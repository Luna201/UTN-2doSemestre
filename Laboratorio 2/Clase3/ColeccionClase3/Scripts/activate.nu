...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\LUNA\II-Laboratorio2\Clase3\ColeccionClase3'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\LUNA\II-Laboratorio2\Clase3\ColeccionClase3\Scripts\deactivate.nu'
