class Vehiculo:
    """
    efinir una clase padre llamada Vehiculo y dos clase hijas llamadas Auto y Bicicleta, las cuales
    heredaran de la clase padre Vehiculo. La clase padre debe tener los siguientes atributos y métodos:
    ...
    Biclicleta(clase hija de vehiculo)
