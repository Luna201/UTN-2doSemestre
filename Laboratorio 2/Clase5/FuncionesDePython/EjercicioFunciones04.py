...
formula: pago_total = pago_sin_impuesto + pago_son_impuesto * (impesto/100)
Proporcione el pago sin impuesto: 1000
Proporcione el monto del impuesto: 21%
Pago con impuesto: XXXX
"""
# Creamos la función que calcula el total del pago incluyendo el impesto
...
impuesto = float(input("Digite el monto del impuetso a aplicar: "))
